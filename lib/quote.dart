...
import 'package:quotesmaker/responsive.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(actions: [
        IconButton(onPressed: ()=> _drawerProvider.changeThemeMode(), icon:  Icon(_drawerProvider.themeMode== ThemeMode.light ? Icons.dark_mode : Icons.light_mode))
      ],),
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
                ...
                constraints: BoxConstraints(maxWidth: Responsive.isDesktop(context) ? 1000 : 400),
